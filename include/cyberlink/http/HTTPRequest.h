...
public:
  ...
  HTTPRequest();
  HTTPRequest(cyber_shared_ptr<HTTPSocket> httpSock);
  ~HTTPRequest();
...
public:
 ...
 public:
  void setSocket(cyber_shared_ptr<HTTPSocket> socket) {
    httpSocket = socket;
  }
    
  cyber_shared_ptr<HTTPSocket> getSocket() {
    return httpSocket;
  }
