...
class Action {
  ...
  cyber_shared_ptr<uXML::Node> actionNode;
...
public:
  ...
  Action(cyber_shared_ptr<uXML::Node> serviceNode, cyber_shared_ptr<uXML::Node> actionNode);
 ...
 public:
  ...
  static bool isActionNode(cyber_shared_ptr<uXML::Node> node) {
