...
class AllowedValueRange {
  cyber_shared_ptr<uXML::Node> allowedValueRangeNode;
...
public:
 ...
 public:
  void setAllowedValueRangeNode(cyber_shared_ptr<uXML::Node> node) {
    allowedValueRangeNode = node;
  }

  cyber_shared_ptr<uXML::Node> getAllowedValueRangeNode() {
...
public:
  ...
  AllowedValueRange() {
    setAllowedValueRangeNode(cyber_shared_ptr<uXML::Node>((uXML::Node *)nullptr));
  }

  AllowedValueRange(cyber_shared_ptr<uXML::Node> node) {
