...
namespace CyberLink {
class Icon {
  cyber_shared_ptr<uXML::Node> iconNode;
 ...
 public:
  ...
  cyber_shared_ptr<uXML::Node> getIconNode() {
    return iconNode;
  }
  ...
  Icon(cyber_shared_ptr<uXML::Node> node) {
    iconNode = node;
  }
  ...
  static bool isIconNode(cyber_shared_ptr<uXML::Node> node) {
