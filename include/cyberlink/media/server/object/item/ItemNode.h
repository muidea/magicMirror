...
public:
	...
	static bool isItemNode(uXML::Node *node);
...
public:
	...
	void addContentNode(cyber_shared_ptr<ContentNode> node);
	bool removeContentNode(cyber_shared_ptr<ContentNode> node);
...
public:
	...
	void setResource(const char *url, const char *protocolInfo, uXML::AttributeList *attrList);

	void setResource(const char *url, const char *protocolInfo)
	{
		uXML::AttributeList attrList;
...
public:
	...
	virtual InputStream *getContentInputStream() = 0;
