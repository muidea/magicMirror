...
#include <media/server/action/SearchAction.h>
#include <media/server/DirectoryList.h>
#include <media/server/object/FormatList.h>
#include <media/server/object/SearchCapList.h>
#include <media/server/object/SortCapList.h>
#include <media/server/object/container/RootNode.h>
#include <media/server/object/ContentNodeList.h>
#include <media/server/object/item/ItemNodeList.h>
...
class ContentDirectory : public Thread, public ActionListener, public QueryListener
{
...
public:
	...
	void contentExportRequestRecieved(HTTPRequest *httpReq);
