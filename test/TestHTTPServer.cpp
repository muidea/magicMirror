...
#include <io/StringBufferInputStream.h>
#include <iostream>
#include <sstream>
...
HTTP::StatusCode TestHTTPServer::httpRequestRecieved(HTTPRequest *httpReq)
{
  string uri;
  httpReq->getURI(uri);
...
HTTP::StatusCode TestHTTPServer::httpInputStreamRequestRecieved(HTTPRequest *httpReq)
{
...
HTTP::StatusCode TestHTTPServer::httpChunkedStreamRequestRecieved(HTTPRequest *httpReq)
{
  HTTPResponse httpRes;
