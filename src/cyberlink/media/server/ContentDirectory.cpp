...
#include <media/server/object/DIDLLite.h>
#include <media/server/object/item/ItemNode.h>
#include <media/server/object/SortCriteriaList.h>
#include <media/server/object/SearchCriteriaList.h>
...
#include <media/server/object/SortCap.h>
#include <media/server/object/sort/UPnPClassSortCap.h>
#include <media/server/object/sort/DCTitleSortCap.h>
#include <media/server/object/sort/DCDateSortCap.h>

#include <media/server/object/SearchCap.h>
#include <media/server/object/search/IdSearchCap.h>
...
bool ContentDirectory::addDirectory(Directory *dir)
{
	...
	cyber_shared_ptr<ContentNode> node(dir);
	rootNode.addContentNode(node);
...
void ContentDirectory::contentExportRequestRecieved(HTTPRequest *httpReq)
{
	if (Debug::isOn())
		httpReq->print();
