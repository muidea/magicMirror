...
#include <media/server/directory/file/FileDirectory.h>
...
bool FileDirectory::updateItemNode(FileItemNode *itemNode,  File *file)
{
...
FileItemNode *FileDirectory::createCompareItemNode(File *file)
{
	Format *format = getContentDirectory()->getFormat(file);
	if (format == NULL)
		return NULL;
...
int FileDirectory::getDirectoryItemNodeList(File *dirFile, FileItemNodeList &itemNodeList)
{
	FileList fileList;
...
FileItemNode *FileDirectory::getItemNode(File *file)
{
