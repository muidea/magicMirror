...
#include <media/server/object/format/ID3Format.h>
...
bool ID3Format::loadHeader(InputStream *in)
{
...
bool ID3Format::loadHeader(File *file)
{
...
bool ID3Format::equals(File *file)
{
	if (file == NULL)
		return false;
...
int ID3Format::getAttributeList(uXML::AttributeList &attrList)
{
	File *file = getFile();
	if (file == NULL)
