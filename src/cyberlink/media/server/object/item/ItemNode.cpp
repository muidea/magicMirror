...
bool ItemNode::isItemNode(uXML::Node *node)
{
...
void ItemNode::addContentNode(cyber_shared_ptr<ContentNode> node)
{
	addNode(node);
...
bool ItemNode::removeContentNode(cyber_shared_ptr<ContentNode> node)
{
...
void ItemNode::setResource(const char *url, const char *protocolInfo, uXML::AttributeList *attrList)
{
