...
bool ContainerNode::isContainerNode(uXML::Node *node)
{
...
void ContainerNode::addContentNode(cyber_shared_ptr<ContentNode> node)
{
	addNode(node);
...
bool ContainerNode::removeContentNode(cyber_shared_ptr<ContentNode> node)
{
