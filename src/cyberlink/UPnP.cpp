...
void UPnP::SetEnable(int value) {
  ...
  case USE_ONLY_IPV6_ADDR:
    {
      CyberLink::HostInterface::USE_ONLY_IPV6_ADDR = true;
    }
    break;  
  case USE_ONLY_IPV4_ADDR:
    {
      CyberLink::HostInterface::USE_ONLY_IPV4_ADDR = true;
    }
    break;  
  case USE_LOOPBACK_ADDR:
    {
      CyberLink::HostInterface::USE_LOOPBACK_ADDR = true;
    }
    break;  
...
void UPnP::SetDisable(int value) {
  ...
  case USE_ONLY_IPV6_ADDR:
    {
      CyberLink::HostInterface::USE_ONLY_IPV6_ADDR = false;
    }
    break;  
  case USE_ONLY_IPV4_ADDR:
    {
      CyberLink::HostInterface::USE_ONLY_IPV4_ADDR = false;
    }
    break;  
  case USE_LOOPBACK_ADDR:
    {
      CyberLink::HostInterface::USE_LOOPBACK_ADDR = false;
    }
    break;  
  }
}
...
bool UPnP::IsEnabled(int value) {
  ...
  case USE_ONLY_IPV6_ADDR:
    {
      return CyberLink::HostInterface::USE_ONLY_IPV6_ADDR;
    }
  case USE_ONLY_IPV4_ADDR:
    {
      return CyberLink::HostInterface::USE_ONLY_IPV4_ADDR;
    }
  case USE_LOOPBACK_ADDR:
    {
      return CyberLink::HostInterface::USE_LOOPBACK_ADDR;
    }
  }
  return false;
}
